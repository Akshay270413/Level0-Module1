...
def mouse_pressed(event):
    ...
    # of a triangle
    canvas.create_oval(x - 100, y+50, x + 100, y + 250, fill='red')
    canvas.create_oval(x- 50, y+50, x+50, y+200, fill='orange')
    canvas.create_oval(x-25, y+50, x+50, y+175, fill='yellow')
